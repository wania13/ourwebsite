...
<DIV style="background-color: white; width: 80%; height: auto; margin-top: 150px; margin-left: 90px;">

 	<form action="" method="POST" enctype="multipart/form-data" style="margin-left: 450px;margin-top: 100px;">
		<input type="submit" name="submit" value="show catagories" style=" height: 100px; width:300px;color:white;background-color: #ff5c33; font-size: 30px;font-family: serif; border-radius: 7PX;">
    </form>
				...
				{	
			       ...
			       while($answer=mysqli_fetch_array($results))
                    ...
                    if ($answer['submenu_id']!='10')
   			      	{	echo "<td ><a style='text-decoration:none ;font-family:serif;color:BROWN;font-size:17px;' href=menuitems.php?submenu_id=".$answer['submenu_id'].">Click to view items</a></td>";}

   			            if ($answer['submenu_id']=='10')
                      { echo "<td><a style='text-decoration:none ; font-family:serif;color:BROWN;font-size:20px;' href=menudessert.php?submenu_id=".$answer['submenu_id'].">More...</a></td>";}
