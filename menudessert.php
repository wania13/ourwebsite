     ...
     $results=mysqli_query($conn,$query2);
       while($answer=mysqli_fetch_array($results))
              ...
              echo "<td>".$answer['desser_id'].".</button></td>";
                ...
                echo "<td><a style='text-decoration:none ; color:brown;font-size:15px;font-family:sans-serif;' href=menudessert2.php?desser_id=".$answer['desser_id'].">Click to view items</a></td>";
